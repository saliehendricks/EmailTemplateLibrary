...
{
    public class PostgreTemplateStorage : TemplateStorage
    {
        private readonly PostgreStorageOptions _options;
        private readonly OrmLiteConnectionFactory _dbFactory;

        public PostgreTemplateStorage(PostgreStorageOptions options)
        {
            _options = options;
            _dbFactory = new OrmLiteConnectionFactory(options.ConnectionString, PostgreSqlDialect.Provider);
